...
namespace Railroad.Migrations
{
    ...
    [Migration("20250828172634_SeedInitialData")]
            ...
            modelBuilder.Entity("Railroad.DAL.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "ivan@mail.com",
                            PersonId = 1,
                            RegistrationDate = new DateTime(2025, 8, 28, 20, 26, 34, 155, DateTimeKind.Local).AddTicks(6972)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            PersonId = 2,
                            RegistrationDate = new DateTime(2025, 8, 28, 20, 26, 34, 157, DateTimeKind.Local).AddTicks(5760)
                        });
                });
            ...
            modelBuilder.Entity("Railroad.DAL.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalPrice = 300m,
                            PricesId = 1,
                            PurchaseDate = new DateTime(2025, 8, 28, 20, 26, 34, 157, DateTimeKind.Local).AddTicks(9777),
                            Seat = 12,
                            TrainRouteId = 1
                        },
                        new
                        {
                            ...
                            FinalPrice = 450m,
                            PricesId = 1,
                            PurchaseDate = new DateTime(2025, 8, 28, 20, 26, 34, 157, DateTimeKind.Local).AddTicks(9916),
                            Seat = 8,
                            TrainRouteId = 2
                        });
                });
